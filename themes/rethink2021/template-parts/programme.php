...
<?php if (is_admin()) {
    echo '<p class="b-programme-hint"> <code >hint: this is the ' .  $args["data"]["title"] . ' programme snippets block</code></p>';
    }
?>
<div class="b-programme-wrapper  b-programme-wrapper--<?php echo $args['data']['location_value']?>">
